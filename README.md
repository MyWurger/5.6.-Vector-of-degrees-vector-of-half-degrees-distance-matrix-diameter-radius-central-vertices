...
вектор степеней вершин (граф) / вектора полустепеней входа и выхода
(орграф), матрицу расстояний, диаметр (граф), радиус (граф), множество
центральных вершин (граф), множество периферийных вершин (граф).
